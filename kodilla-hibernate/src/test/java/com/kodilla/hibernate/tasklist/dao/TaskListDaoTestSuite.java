...
public class TaskListDaoTestSuite {
    ...
    public void testTaskListDaoSaveWithTasks() {
        ...
        TaskList taskList = new TaskList("to do list 2", "ToDo tasks");
    ...
    public void testNamedQueries() {
        ...
        TaskList taskList = new TaskList("to do list 3", "ToDo tasks");
        ...
        List<Task> duartionLongerThanTasks = taskDao.retrieveTasksWithDurationLongerThan(6);
        ...
        try {
            ...
            Assert.assertEquals(2, duartionLongerThanTasks.size());
        } finally {
            //CleanUp
            taskListDao.delete(id);
        }
