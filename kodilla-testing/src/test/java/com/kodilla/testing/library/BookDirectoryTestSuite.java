...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOf() {
        ...
        List<Book> resultList0Books = new ArrayList<Book>();
        List<Book> resultList1Book = generateListOfNBooks(1);
        List<Book> resultList5Books = generateListOfNBooks(5);
        LibraryUser libraryUser1 = new LibraryUser("Anna", "Kowalska", "88042400888");
        LibraryUser libraryUser2 = new LibraryUser("Joanna", "Kowalska", "88042400868");
        LibraryUser libraryUser3 = new LibraryUser("Marianna", "Kowalska", "88042400848");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser1))
                .thenReturn(resultList0Books);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser2))
                .thenReturn(resultList1Book);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser3))
                .thenReturn(resultList5Books);
